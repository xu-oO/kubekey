...
import (
	...
	infracontrolplanev1 "github.com/xu-oO/kubekey/v3/controlplane/k3s/api/v1beta1"
	k3sCluster "github.com/xu-oO/kubekey/v3/controlplane/k3s/pkg/cluster"
	"github.com/xu-oO/kubekey/v3/controlplane/k3s/pkg/kubeconfig"
